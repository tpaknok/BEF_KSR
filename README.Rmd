...
## Data - Phylogeny
KSR_MLtree (or data(KSR_MLtree)) is a phylogeny tree containing the 14 species used in the experiment. 
...
# Figure
The folder contains all result figures included in the manuscript: p_coef(Figure S1), p_KSR (Figure 4), p_KSR_all(Figure S2), p_sim(Figure 3).

# Table
The folder contains Table S2 (before formatting). Note that this is NOT the data.
